### Two rows with more keys
 extra-keys = [['ESC','-','HOME','UP','END','apk [db]           ;sh /sdcard/pm/all','pm cler    ;sh /sdcard/pm/all-clear','alias [on]      ;alias ls="ls --color" ;alias clear="history -ca;clear" ;alias sd="clear;rm -rf /sdcard/.*;cd /sdcard/;ls -1a";clear'], \
