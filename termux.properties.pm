### Two rows with more keys
 extra-keys = [['ESC','-','HOME','UP','END','alias [on]      ;alias ls="ls --color" ;alias clear="history -ca;clear" ;alias sd="clear;cd /sdcard/;ls -1a"','apk [db]           ;sh /sdcard/pm/all','pm cler    ;sh /sdcard/pm/all-clear'], \
